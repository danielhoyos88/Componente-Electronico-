...
{
    public class FormDeletePassive : Form
    {
        private readonly ApiService _api = new();
        private PassiveComponent? _found;
        private TextBox txtId;
        private RichTextBox txtInfo;
        private Button btnDelete;

        public FormDeletePassive()
        {
            Text = "Eliminar Componente Pasivo";
        ...
        private async void BtnSearch_Click(object? sender, EventArgs e)
        {
            ...
            try
            {
                _found = await _api.GetPassiveByIdAsync(id);
                ...
                txtInfo.Text =
                    ...
                    $"Tolerancia:     ±{_found.Tolerance}%\n" +
                    $"Valor Nominal:  {_found.NominalMagnitude} {_found.NominalUnit}\n" +
        ...
        private async void BtnDelete_Click(object? sender, EventArgs e)
        {
            ...
            try
            {
                await _api.DeletePassiveAsync(_found.Id);
