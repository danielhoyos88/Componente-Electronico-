...
{
    public class FormSearchActive : Form
    {
        ...
        {
            Text = "Consultar Componente Activo";
            ...
            {
                Left = 15, Top = 90, Width = 370, Height = 240,
        ...
        private async void BtnSearch_Click(object? sender, EventArgs e)
        {
            ...
            try
            {
                ActiveComponent? c = await _api.GetActiveByIdAsync(id);
                ...
                txtResult.Text =
                    ...
                    $"Factor Ganancia:  {c.GainFactor}\n" +
                    $"Pines:            {string.Join(", ", c.PinNames)}\n" +
